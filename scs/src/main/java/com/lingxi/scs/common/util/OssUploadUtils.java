package com.lingxi.scs.common.util;
...
public class OssUploadUtils {
    ...
    public static boolean uploadFile(String bucket, String objectKey, String uploadFilePath) {
        ...
        String endpoint = "https://oss-cn-shenzhen.aliyuncs.com";        // 填写 Bucket 所在地域。以华东 1（杭州）为例，Region 填写为 cn-hangzhou
    ...
    public static boolean downloadFile(String bucket, String objectKey, String localFilePath) {
        ...
        String endpoint = "https://oss-cn-shenzhen.aliyuncs.com";        // 填写 Bucket 所在地域。以北京为例，Region 填写为 cn-beijing
        String region = "cn-shenzhen";
        String accessKeyId = System.getenv("OSS_ACCESS_KEY_ID");
        String accessKeySecret = System.getenv("OSS_ACCESS_KEY_SECRET");
